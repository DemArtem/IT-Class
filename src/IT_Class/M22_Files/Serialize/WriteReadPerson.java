package IT_Class.M22_Files.Serialize;
...
public class WriteReadPerson {
    ...
    static void writePerson() throws IOException {
        FileOutputStream file = new FileOutputStream("src/_data/person.bin");
    ...
    static void readPerson() throws IOException, ClassNotFoundException {
        FileInputStream file = new FileInputStream("src/_data/person.bin");
